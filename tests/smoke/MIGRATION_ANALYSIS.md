...
- **9** smokes in `tests/smoke/cases/` that still use `command_manager.execute`.
...
### tests/smoke/cases/test_arrow_left_at_start_boundary_clamps.py
...
### tests/smoke/cases/test_extend_edit_at_start_boundary.py
...
### tests/smoke/cases/test_goto_mark_uses_live_clip_in_out.py
...
### tests/smoke/cases/test_keymap_alt_i_o_x_clear_marks.py
- **Compliance**: VIOLATES — `SetMarkIn`/`SetMarkOut` setup.
- **Migration**: I/O keypress at chosen playhead positions.

### tests/smoke/cases/test_keymap_cmd_1234_select_panel.py
- **Compliance**: ✅ COMPLIANT.

### tests/smoke/cases/test_keymap_cmd_a_shift_a_selection.py
...
### tests/smoke/cases/test_keymap_cmd_shift_bracket_trim_head_tail.py
- **Compliance**: VIOLATES — `SelectClips` + `SetPlayhead`.
- **Migration**: `click_clip`, `move_playhead_to`.

### tests/smoke/cases/test_keymap_d_toggles_clip_enabled.py
- **Compliance**: VIOLATES — `SelectClips`.
- **Migration**: `click_clip`.

### tests/smoke/cases/test_keymap_delete_lift.py
- **Compliance**: VIOLATES — `SelectClips` + `SetPlayhead`.
- **Migration**: `click_clip`, `move_playhead_to`.

### tests/smoke/cases/test_keymap_dispatch_no_crash.py
...
### tests/smoke/cases/test_keymap_f_match_frame.py
- **Compliance**: VIOLATES — `SetPlayhead`.
- **Migration**: `move_playhead_to`.

### tests/smoke/cases/test_keymap_grave_toggles_tab.py
- **Compliance**: ✅ COMPLIANT.
- **Notes**: smoke that triggered OpenProject hang in next test class (Task #8) — investigate state-leak.

### tests/smoke/cases/test_keymap_i_sets_mark_in.py
- **Compliance**: VIOLATES — `SetPlayhead`.
- **Migration**: `move_playhead_to`.

### tests/smoke/cases/test_keymap_n_toggles_snapping.py
- **Compliance**: ✅ COMPLIANT.

### tests/smoke/cases/test_keymap_nudge_selection.py
- **Compliance**: VIOLATES — `SelectClips`.
- **Migration**: `click_clip`.

### tests/smoke/cases/test_keymap_o_sets_mark_out.py
- **Compliance**: VIOLATES — `SetPlayhead`.
- **Migration**: `move_playhead_to`.

### tests/smoke/cases/test_keymap_shift_f_opens_clip_in_source_viewer.py
- **Compliance**: VIOLATES — `SetPlayhead`.
- **Migration**: `move_playhead_to`.

### tests/smoke/cases/test_keymap_shift_f12_toggle_profiler.py
- **Compliance**: ✅ COMPLIANT.

### tests/smoke/cases/test_keymap_shift_i_goto_mark_in.py
- **Compliance**: VIOLATES — `SetMarkIn` + `SetPlayhead`.
- **Migration**: `move_playhead_to` + I keypress to set mark.

### tests/smoke/cases/test_keymap_shift_o_goto_mark_out.py
- **Compliance**: VIOLATES — `SetMarkOut` + `SetPlayhead`.
- **Migration**: `move_playhead_to` + O keypress.

### tests/smoke/cases/test_keymap_timeline_zoom.py
...
### tests/smoke/cases/test_keymap_undo_redo.py
- **Compliance**: VIOLATES — `SelectClips`.
- **Migration**: `click_clip`.

### tests/smoke/cases/test_keymap_x_mark_clip_extent.py
- **Compliance**: VIOLATES — `SetPlayhead` + `ClearMarks`.
- **Migration**: `move_playhead_to` + Alt+X.

### tests/smoke/cases/test_live_bound_marks_show_clip_in_out.py
- **Compliance**: VIOLATES — direct `load_clip()` Lua call.
- **Migration**: Shift+F at a clip's playhead position.

### tests/smoke/cases/test_move_playhead_syncs_engine.py
...
### tests/smoke/cases/test_nudge_clip_at_start_boundary_clamps.py
- **Compliance**: VIOLATES — `SelectClips`.
- **Migration**: `click_clip`.

### tests/smoke/cases/test_open_project_no_active_sequence.py
...
### tests/smoke/cases/test_playhead_below_start_clamps.py
...
### tests/smoke/cases/test_roll_in_edge_at_start_boundary_clamps.py
...
### tests/smoke/cases/test_runner_sanity.py
- **Compliance**: ✅ COMPLIANT (runner-tier, not JVE test).

### tests/smoke/cases/test_shift_f_parks_playhead_at_clip_source_in.py
...
### tests/smoke/cases/test_source_viewer_marks_track_live_clip_mutations.py
