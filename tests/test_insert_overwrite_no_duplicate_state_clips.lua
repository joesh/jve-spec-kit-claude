...
conn:exec(string.format([[
    INSERT INTO projects (id, name, created_at, modified_at) VALUES ('proj', 'Test', %d, %d);
    ...
    VALUES ('seq', 'proj', 'TL', 'timeline', 25, 1, 48000, 1920, 1080, 0, 0, 8000, %d, %d);
...
cmd:set_parameters({
    master_clip_id = mc, track_id = "v1", sequence_id = "seq",
