...
assert(qt_constants.EMP.ASSET_OPEN, "ASSET_OPEN should exist")
...
local asset, err = qt_constants.EMP.ASSET_OPEN("/nonexistent/file.mp4")
...
assert(not status, "ASSET_INFO(nil) should fail")
