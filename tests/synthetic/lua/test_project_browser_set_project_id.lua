...
local seq1 = Sequence.create("Timeline One", project1.id, { fps_numerator = 30, fps_denominator = 1}, 1920, 1080, { kind = "sequence", audio_sample_rate = 48000 })
...
local seq2 = Sequence.create("Timeline Two", project2.id, { fps_numerator = 24, fps_denominator = 1}, 1920, 1080, { kind = "sequence", audio_sample_rate = 48000 })
