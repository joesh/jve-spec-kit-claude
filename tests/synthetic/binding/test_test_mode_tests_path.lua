...
--
-- These modules live directly under tests/ and tests/synthetic/integration/ and require
...
local ok_env, env = pcall(require, "synthetic.integration.ui_test_env")
assert(ok_env, "require('synthetic.integration.ui_test_env') failed — tests/ not on package.path: " .. tostring(env))
