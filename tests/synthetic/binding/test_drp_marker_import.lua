...
-- entered.
--
-- Run: ./build/bin/jve.app/Contents/MacOS/jve --test tests/synthetic/binding/test_drp_marker_import.lua
...
-- Bootstrap mirrors tests/synthetic/binding/test_import_resolve_drp.lua exactly.
