...
db:exec(string.format([[
    INSERT INTO projects (id, name, created_at, modified_at) VALUES ('p', 'P', %d, %d);
    INSERT INTO sequences (id, project_id, name, kind, fps_numerator, fps_denominator,
                           audio_rate, width, height, playhead_frame, view_start_frame,
    ...
    VALUES ('s', 'p', 'S', 'timeline', 25, 1, 48000, 1920, 1080, 0, 0, 240,
            '[]', '[]', '[]', 0, %d, %d);
]], now, now, now, now))
