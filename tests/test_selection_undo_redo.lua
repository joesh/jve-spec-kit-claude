...
db:exec(string.format([[
    INSERT INTO projects (id, name, fps_mismatch_policy, settings, created_at, modified_at) VALUES ('test_project', 'Test Project', 'resample', '{"master_clock_hz":192000,"default_fps":{"num":24,"den":1}}', %d, %d);
    ...
    VALUES ('test_sequence', 'test_project', 'Test Sequence', 'sequence', 30, 1, 48000, 1920, 1080, 0, 600, 0,
        '[]', '[]', '[]', 0, %d, %d);
    ...
    -- V13 master sequence + track + media_ref for media_clip
INSERT INTO sequences (id, project_id, name, kind, fps_numerator, fps_denominator, audio_sample_rate, width, height, created_at, modified_at)
VALUES ('master_media_clip', 'test_project', 'media_clip_master', 'master', 30, 1, NULL, 1920, 1080, 0, 0);
INSERT INTO tracks (id, sequence_id, name, track_type, track_index, enabled, locked, muted, soloed, volume, pan)
VALUES ('master_v_media_clip', 'master_media_clip', 'V1', 'VIDEO', 1, 1, 0, 0, 0, 1.0, 0.0);
UPDATE sequences SET default_video_layer_track_id = 'master_v_media_clip' WHERE id = 'master_media_clip';
...
VALUES ('mr_media_clip', 'test_project', 'master_media_clip', 'master_v_media_clip', 'media_clip', 0, 1000, 0, 1000, 48000, 1, 1.0, 0, 0, 0);
...
VALUES
    ('clip0', 'test_project', '', 'track_test_v1', 'master_media_clip', 'test_sequence', 0, 1000, 0, 1000, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0);
    INSERT INTO clips (id, project_id, name, track_id, sequence_id, owner_sequence_id, sequence_start_frame, duration_frames, source_in_frame, source_out_frame, enabled, created_at, modified_at, master_layer_track_id, master_audio_track_id, fps_mismatch_policy, volume, playhead_frame)
VALUES
    ('clip1', 'test_project', '', 'track_test_v1', 'master_media_clip', 'test_sequence', 2000, 1000, 0, 1000, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0);
    INSERT INTO clips (id, project_id, name, track_id, sequence_id, owner_sequence_id, sequence_start_frame, duration_frames, source_in_frame, source_out_frame, enabled, created_at, modified_at, master_layer_track_id, master_audio_track_id, fps_mismatch_policy, volume, playhead_frame)
VALUES
    ('clip2', 'test_project', '', 'track_test_v1', 'master_media_clip', 'test_sequence', 4000, 1000, 0, 1000, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0);
