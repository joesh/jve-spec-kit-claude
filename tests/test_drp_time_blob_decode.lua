...
local result = drp_importer._decode_bt_video_time(time_blob_5field)
...
local result2 = drp_importer._decode_bt_video_time(time_blob_2890)
...
local result3 = drp_importer._decode_bt_video_time(time_blob_6field)
...
local result4 = drp_importer._decode_bt_audio_duration(tracks_ba_embedded)
...
local result5 = drp_importer._decode_bt_audio_duration(tracks_ba_standalone)
...
assert(drp_importer._decode_bt_video_time(nil) == nil, "nil input → nil")
assert(drp_importer._decode_bt_video_time("") == nil, "empty input → nil")
assert(drp_importer._decode_bt_video_time("0000") == nil, "truncated → nil")
assert(drp_importer._decode_bt_video_time("zzzzzzzzzzzzzzzzzzzzzzzz") == nil, "garbage → nil")
-- Valid header but truncated before fields
assert(drp_importer._decode_bt_video_time("0000000100000005") == nil, "header-only → nil")

assert(drp_importer._decode_bt_audio_duration(nil) == nil, "nil input → nil")
assert(drp_importer._decode_bt_audio_duration("") == nil, "empty input → nil")
assert(drp_importer._decode_bt_audio_duration("0000") == nil, "truncated → nil")
assert(drp_importer._decode_bt_audio_duration("zzzzzzzzzzzzzzzzzzzz") == nil, "garbage → nil")
