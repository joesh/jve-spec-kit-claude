...
``l2``-exempt in ``tests/live/runner/keymap_exempt.py``, focus the
...
Run:
    python3 -m unittest tests.live.cases.test_keymap_dispatch_no_crash -v
"""
...
from tests.live.runner.coverage import list_keymap_bindings
from tests.live.runner.keymap_exempt import l2_skip_reason
...
class TestKeymapDispatchNoCrash(JVESmokeCase):
    ...
    def _suite_log_path(self) -> Path:
        # Mirrors tests/live/runner/case.py:_ensure_runner().
