...
local exec_result, exec_err = db:exec(string.format([[
    ...
    VALUES ('test_project', 'Replay Test Project', 'resample', '{"master_clock_hz":192000,"default_fps":{"num":24,"den":1}}', %d, %d);
...
VALUES ('_v13_placeholder_master', 'test_project', 'placeholder_master', 'master', 30, 1, NULL, 1920, 1080, 0, 0);
...
VALUES ('_v13_placeholder_mr', 'test_project', '_v13_placeholder_master', '_v13_placeholder_track', '_v13_placeholder_media', 0, 2000, 0, 2000, 48000, 1, 1.0, 0, 0, 0);
