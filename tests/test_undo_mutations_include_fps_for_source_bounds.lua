...
VALUES
    ('clip1', 'default_project', 'Clip 1', 'v1', 'master_media1', 'seq1', 0, 200, 0, 200, 1, 0, 0, NULL, NULL, 'resample', 1.0, 0);
]]
...
overwrite_cmd:set_parameter("timeline_start_frame", 100)  -- Start at frame 100
