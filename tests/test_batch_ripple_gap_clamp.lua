...
VALUES ('mr_media1', 'default_project', 'master_media1', 'master_v_media1', 'media1', 0, 20000, 0, 20000, 1, 1.0, 0, 0, 0);
...
VALUES
    ('clip_a', 'default_project', 'A', 'track_v1', 'master_media1', 'default_sequence', 0, 2000, 0, 2000, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0),
    ('clip_b', 'default_project', 'B', 'track_v1', 'master_media1', 'default_sequence', 14000, 1000, 0, 1000, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0),
    ('clip_left_v2', 'default_project', 'Left V2', 'track_v2', 'master_media1', 'default_sequence', 2000, 3000, 0, 3000, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0),
    ('clip_right', 'default_project', 'Right', 'track_v2', 'master_media1', 'default_sequence', 13000, 1000, 0, 1000, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0);
...
local stmt = assert(db:prepare("SELECT sequence_start_frame FROM clips WHERE id = 'clip_right'"))
...
local stmt2 = assert(db:prepare("SELECT sequence_start_frame FROM clips WHERE id = 'clip_b'"))
