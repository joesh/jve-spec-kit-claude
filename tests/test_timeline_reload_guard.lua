...
local DATA_SQL = [[
    ...
    VALUES
        ('seq_a', 'default_project', 'Active Seq', 'nested', 30, 1, 48000, 1920, 1080, 0, 240, 0, '[]', '[]', '[]', 0, 0, 0),
        ('seq_b', 'default_project', 'Background Seq', 'timeline', 30, 1, 48000, 1920, 1080, 0, 240, 0, '[]', '[]', '[]', 0, 0, 0);
