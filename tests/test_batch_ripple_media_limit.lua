...
VALUES ('_v13_placeholder_master', 'default_project', 'placeholder_master', 'master', 24, 1, NULL, 1920, 1080, 0, 0);
...
VALUES ('_v13_placeholder_mr', 'default_project', '_v13_placeholder_master', '_v13_placeholder_track', '_v13_placeholder_media', 0, 600, 0, 600, 48000, 1, 1.0, 0, 0, 0);
...
assert(clip.sequence_start == 240, string.format("Ripple trim should keep clip anchored; expected 240, got %d", clip.sequence_start))
