...
local v1 = drp_importer.parse_resolve_tracks(seq1, { frame_rate = 25 })  -- SEQUENCE is 25fps
...
local v2 = drp_importer.parse_resolve_tracks(seq2, { frame_rate = 25 })
...
local v3 = drp_importer.parse_resolve_tracks(seq3, {frame_rate = 25})
...
local v4 = drp_importer.parse_resolve_tracks(seq4, {frame_rate = 25})
