...
db:exec(string.format([[
    ...
    VALUES ('test_project', 'Metadata Test Project', 'resample', '{"master_clock_hz":192000,"default_fps":{"num":24,"den":1}}', %d, %d);
    ...
    VALUES ('test_seq', 'test_project', 'Original Name', 'sequence',
