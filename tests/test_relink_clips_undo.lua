...
-- Seed: project, sequence, track, media, 2 timeline clips
db:exec(string.format([[
    INSERT INTO projects (id, name, created_at, modified_at, settings)
    VALUES ('%s', 'Relink Project', %d, %d, '{}');
    ...
    VALUES ('%s', '%s', 'Seq', 'timeline', 25, 1, 48000, 1920, 1080, 0, 240, 0, '[]', '[]', '[]', 0, %d, %d);
    ...
    VALUES ('%s', '%s', 'timeline', 'Clip1', '%s', '%s',
        '%s', 0, 100, 100, 200, 25, 1,
        1, 0, 0, %d, %d);
    ...
    INSERT INTO clips (id, project_id, clip_kind, name, track_id, media_id,
        ...
        source_in_frame, source_out_frame, fps_numerator, fps_denominator,
        enabled, offline, playhead_frame, created_at, modified_at)
    VALUES ('%s', '%s', 'timeline', 'Clip2', '%s', '%s',
        '%s', 100, 50, 300, 350, 25, 1,
        1, 0, 0, %d, %d);
]], project_id, now, now,
