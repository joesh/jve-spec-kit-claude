...
VALUES ('master_media_test', 'default_project', 'media_test_master', 'master', 30, 1, 48000, 1920, 1080, strftime('%s','now'), strftime('%s','now'));
...
INSERT INTO clips (id, project_id, master_clip_id, owner_sequence_id, track_id, nested_sequence_id, name, timeline_start_frame, duration_frames, source_in_frame, source_out_frame, enabled, created_at, modified_at, master_layer_track_id, master_audio_track_id, fps_mismatch_policy, volume, playhead_frame)
VALUES
    ('clip_delete_test', 'default_project', 'mc_seq', 'default_sequence', 'track_v1', 'master_media_test', 'Test Clip', 0, 30, 0, 30, 1, 0, 0, NULL, NULL, 'resample', 1.0, 0);
]])
