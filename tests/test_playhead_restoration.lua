...
db:exec(string.format([[
    ...
    VALUES ('test_project', 'Test Project', 'resample', '{"master_clock_hz":192000,"default_fps":{"num":24,"den":1}}', %d, %d);
    ...
    INSERT INTO sequences (
        ...
        'test_sequence', 'test_project', 'Test Sequence', 'sequence',
...
cmd2:set_parameter("audio_sample_rate", 48000)
