...
VALUES ('_v13_placeholder_mr', 'default_project', '_v13_placeholder_master', '_v13_placeholder_track', '_v13_placeholder_media', 0, 2000, 0, 2000, 48000, 1, 1.0, 0, 0, 0);
...
local function fetch_fields(id)
    local stmt = db:prepare("SELECT sequence_start_frame, enabled FROM clips WHERE id = ?")
