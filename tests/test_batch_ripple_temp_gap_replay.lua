...
local seed = string.format([[
    ...
    VALUES ('default_sequence', 'default_project', 'Timeline', 'sequence', 30, 1, 48000, 1920, 1080, 0, 0, 300, %d, %d);
...
VALUES ('_v13_placeholder_mr', 'default_project', '_v13_placeholder_master', '_v13_placeholder_track', '_v13_placeholder_media', 0, 30, 0, 30, 48000, 1, 1.0, 0, 0, 0);
