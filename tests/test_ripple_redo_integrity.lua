...
local function setup_db(path)
    ...
    assert(conn:exec([[
INSERT INTO projects (id, name, fps_mismatch_policy, created_at, modified_at) VALUES ('default_project', 'Default Project', 'resample', strftime('%s','now'), strftime('%s','now'));
...
VALUES ('default_sequence', 'default_project', 'Default Sequence', 'nested', 30, 1, 48000, 1920, 1080, 0, 10000, 0, strftime('%s','now'), strftime('%s','now'));
