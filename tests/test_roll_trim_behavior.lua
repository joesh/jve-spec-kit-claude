...
local seed = string.format([[
    ...
    VALUES ('default_sequence', 'default_project', 'Timeline', 'sequence', 1000, 1, 48000, 1920, 1080, 0, 240, 0, %d, %d);
...
VALUES ('mr_media1', 'default_project', 'master_media1', 'master_v_media1', 'media1', 0, 5000, 0, 5000, 48000, 1, 1.0, 0, 0, 0);
...
VALUES
    ('clip_left', 'default_project', 'Left', 'track_v1', 'master_media1', 'default_sequence', 0, 1000, 0, 1000, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0),
    ('clip_right', 'default_project', 'Right', 'track_v1', 'master_media1', 'default_sequence', 1000, 1000, 0, 1000, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0),
    ('clip_downstream', 'default_project', 'Downstream', 'track_v1', 'master_media1', 'default_sequence', 2000, 1000, 0, 1000, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0);
