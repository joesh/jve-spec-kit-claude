...
local seq1 = Sequence.create("Timeline One", project1.id, {kind = "nested", fps_numerator = 30, fps_denominator = 1}, 1920, 1080, {})
...
local seq2 = Sequence.create("Timeline Two", project2.id, {kind = "nested", fps_numerator = 24, fps_denominator = 1}, 1920, 1080, {})
