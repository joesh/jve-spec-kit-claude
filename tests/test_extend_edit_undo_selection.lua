...
assert(db:exec(string.format([[
    ...
    VALUES ('default_sequence', 'default_project', 'Timeline', 'nested', 30, 1, 48000, 1920, 1080, 0, 600, 0, %d, %d);
...
VALUES
    ('clip_v1', 'default_project', 'ClipV1', 'track_v1', 'master_media1', 'default_sequence', 0, 100, 0, 100, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0),
    ('clip_v2', 'default_project', 'ClipV2', 'track_v2', 'master_media1', 'default_sequence', 0, 100, 0, 100, 1, %d, %d, NULL, NULL, 'resample', 1.0, 0);
