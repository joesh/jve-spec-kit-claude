...
local success, result = pcall(function()
    ...
    -- Add the src directory to the package path
    ...
    if mount_result and mount_result.success then
        ...
        print("🔧 Creating schema-driven inspector...")
        local inspector_result = view.create_schema_driven_inspector()
        
        if inspector_result and inspector_result.success then
            print("✅ Schema-driven inspector created")
        else
            print("⚠️ Schema-driven inspector creation failed: " .. tostring(inspector_result))
        end
