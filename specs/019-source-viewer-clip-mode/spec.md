...
- **FR-024** `keymaps/default.jvekeys`:
  ...
  - Pinned by `tests/smoke/cases/test_shift_f_parks_playhead_at_clip_source_in.py` (match-frame mapping + focus-stays-on-timeline + Joe's manual repro: Shift+F, `\``-toggle, move rec, Shift+F → src tracks the new offset).
