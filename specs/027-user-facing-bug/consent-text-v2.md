# JVE Bug Reporter — Privacy Consent (v2)
...
open the Privacy & Bug Reporting panel (**Cmd+,**) and flick the
toggle back on; from the same panel you can also revoke this install
entirely (deletes `~/.jve/install_id.json` so the next launch prompts
fresh).

## Versioning

This is **v2** of the consent text. If JVE ever changes the set of
