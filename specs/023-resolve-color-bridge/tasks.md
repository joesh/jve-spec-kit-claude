...
- [ ] **T054b-4** Phase C `Nudge` (residual pure-record-start shifts) + Phase D shape-fail surface (`unknown_delta_shape`). Remove `assert_no_unimplemented_phases`. Closes T054b. Registered command (FR-023). Tests RED→GREEN.
