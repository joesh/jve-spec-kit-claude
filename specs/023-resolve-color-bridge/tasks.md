...
- [ ] **T049c** Marker stamping (user-consented) — first-connect stamps markers via a new `stamp_identity_marker` helper verb so subsequent syncs are id-anchored. Lands with T048.
