...
- [ ] T001 Read and understand the current pipeline
...
- [ ] T002 [P] Test: max-shift check across multiple tracks in `tests/test_max_shift_check.lua`
...
- [ ] T003 [P] Test: gap-as-clip in constraint computation in `tests/test_gap_as_clip_constraints.lua`
...
- [ ] T004 [P] Test: scoped gap recomputation in `tests/test_scoped_gap_recompute.lua`
...
- [ ] T006 [P] Test: bounded clip access assert in `tests/test_bounded_edit_region.lua`
...
- [ ] T007 Bounded `build_clip_cache` in `src/lua/core/commands/batch_ripple_edit.lua`
...
- [ ] T008 Remove gap special-casing in `src/lua/core/commands/batch_ripple_edit.lua`
...
- [ ] T009 Max-shift check + bulk downstream shift in `src/lua/core/commands/batch_ripple_edit.lua`
...
- [ ] T010 Update `clip_state.apply_mutations` for simplified bulk_shifts in `src/lua/ui/timeline/state/clip_state.lua`
...
- [ ] T011 Scoped `recompute_gap_clips` in `src/lua/ui/timeline/state/timeline_core_state.lua`
...
- [ ] T013 Remove dead code in `src/lua/core/commands/batch_ripple_edit.lua`
...
- [ ] T014 Integration validation — real project timing
