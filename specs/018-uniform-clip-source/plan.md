...
- Existing `Sequence.resolve_master_leaf` (sequence.lua:2202–2270) — the leaf resolver, modified to consume subframe + new clip_position API
...
├── models/
│   ├── sequence.lua                    # MODIFY: resolve_master_leaf consumes subframe (FR-008);
...
4. Resolver update (`resolve_master_leaf` consumes subframe via clip_position; FR-008 test first).
