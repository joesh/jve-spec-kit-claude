...
M.colors = {
    ...
    clip = C.CLIP_VIDEO_FILL,
    clip_video = C.CLIP_VIDEO_FILL,
    clip_audio = C.CLIP_AUDIO_FILL,
    clip_audio_disabled = C.CLIP_MUTED_FILL,
    clip_video_disabled = C.CLIP_MUTED_FILL,
    clip_selected = C.STATE_SELECTED_WARM,
    clip_disabled = C.CLIP_DISABLED_FILL,
    clip_disabled_text = C.CLIP_DISABLED_TEXT,
    clip_video_offline = C.CLIP_OFFLINE_FILL,
    clip_audio_offline = C.CLIP_OFFLINE_FILL,
    clip_offline_text = C.TEXT_ERROR,
    clip_boundary = C.TIMELINE_CANVAS_BG,
    gap_selected_fill = C.STATE_SELECTED_WARM,
    gap_selected_outline = C.STATE_SELECTED_WARM,
    mark_range_fill = C.MARK_RANGE_FILL,
    mark_range_edge = C.ACCENT_PLAYHEAD,
    playhead = C.ACCENT_PLAYHEAD,
