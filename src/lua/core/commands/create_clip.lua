...
function M.register(command_executors, command_undoers, db, set_last_error)
    command_executors["CreateClip"] = function(command)
        ...
        local raw_duration_frames = command:get_parameter("duration_frames")
        local raw_source_in_frame = command:get_parameter("source_in_frame") or 0
        local raw_source_out_frame = command:get_parameter("source_out_frame")
