...
local command_modules = {
    ...
    "edit_history", "exclusive_toggle_track_preference", "extend_edit",
    ...
    "move_channel", "move_clip_to_track", "move_to_bin", "new_bin", "nudge", "nudge_selection", "overwrite",
    ...
    "rename_track", "reorder_master_channel",
    "set_patch", "set_sequence_metadata", "set_sync_mode", "set_track_heights", "set_track_mix_value",
    "set_track_name",
    "setup_project", "show_source_tab", "split_clip", "step_frame", "timecode_entry",
